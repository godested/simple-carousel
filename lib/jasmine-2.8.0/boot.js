...
(function () {
  ...
  /**
   * ## Reporters
   * The `HtmlReporter` builds all of the HTML UI for the runner page. This reporter paints the dots, stars, and clientX's for specs, as well as all spec names and all failures (if any).
   */
